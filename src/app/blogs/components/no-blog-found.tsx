...
function NoBlogFound({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        'mx-auto flex flex-col items-center justify-center space-y-6 rounded-xl border border-surface-200 bg-gradient-to-br from-surface-50 to-surface-100 p-8 shadow-lg',
        className,
      )}
    >
      ...
      <h2 className="text-center font-primary text-3xl font-bold text-primary-500">
        No Blogs Found
      </h2>
