...
const OurProcess = () => {
  ...
  return (
    <div className="font-primary">
      ...
      <div>
        <div
          className="relative w-full items-center justify-center border-b-4 border-t-4 border-white bg-cover bg-center px-4 py-8 text-white md:px-24 md:py-16"
          style={{
        ...
        >
          ...
          <div className="relative z-10 h-full items-center justify-center text-white">
            <div className="text-center text-[13px] md:text-[32px]">
              ...
              <button
                className="relative max-w-[220px] rounded bg-cover bg-center p-6 text-base font-bold text-primary-500 md:p-10 md:text-2xl"
                style={{
